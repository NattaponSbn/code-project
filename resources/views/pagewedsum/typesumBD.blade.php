                    ...
                    <div class="tile-body">
                        ...
                        <div class="btn-layouts-list-coloum">
                            ...
                            <div class="carousel-inner" style="padding:0px 0px 50px 0px;" id="btn-layouts-coloum">
                                <div class="carousel-item active" >
                                    ...
                                    @foreach($datas as $datas)
                                        <a href="itemdetaliBD/{{$datas->project_id}}">
                                            <div class="column" >
                                                <div class="columnimg"><img src="{{URL::to('project/img_logo/'.$datas->logo)}}" alt="" class="fromimg"></div></a>
                                                    <center><a href="itemdetaliBD/{{$datas->project_id}}">
                                                            <div class="textimg">
                                                                <?php
                                                    ...
                                                    <center><a href="itemtypeBD/{{$datas->type_id}}">
                                                            <div class="textimg2"><?php echo $datas->type_name; ?></div>
                                                        </a>
                                                    </center>
                                                    <center>
                                                        <div class="rating">
                            ...
                            <div class="carousel-inner" id="btn-layouts-list">
                                <div class="carousel-item active">
                                    <div class="row ">
                                        @if(isset($datas12)?$datas12:'')
                                            @foreach($datas12 as $aftersearch) 
