        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" style="margin-top:-5px;">
                    ...
                    <div class="card-body" style="font-family: 'Athiti', sans-serif;">
                        <form method="POST" action="registers" method="POST">
                            ...
                            <div class="form-group row  layoutname-top-BD" style="margin-left:230px;margin-top: -54px;">
                                ...
                                <div class="col-md-6 layoutinput">
                                    <select name="branch" class="layoutprovince-size-p form-control @error('name') is-invalid @enderror" style="width: 260%;">
