                ...
                <div class="col-md-12">
                    <div class="tile">
                            <label class="texthe1">ผลลัพธ์การค้นหา </label>
                                <div class="row" >
                                    <div class="tile-body" style="width: 95%;">
                                    @if(isset($detailsearch)?$detailsearch:'')
                                        @foreach($detailsearch as $aftersearch) 
                                            <div class="column-mdd-s">
                                                <div class="layoutMDD">
                                                    <a href="itemdetaliMDD/{{$aftersearch->project_m_id}}">
                                                    <div class="textMDD-h" >
                                                        <b>
                                                            <?php 
                                                    ...
                                                    <div class="textMDD" ><b>คำอธิบาย :</b> 
                                                        <?php 
                                                            $str = $aftersearch->des_m_project;
                                                            $count = utf8_strlen("$str");
                                                            create_str($count,$str,$aftersearch);
                                                        ?>
                                                    </div> 
                                                    <div class="textMDD" ><b>คำสำคัญ :</b> 
                                                        <?php 
                                                    ...
                                                    <div class="textMDD" ><b>ประเภท :</b> <?php echo $aftersearch->genre_name;?></div>
                                                    <div class="rating">
                                                        <?php 
                                                            // $rate = $items->AvgRate;
                                                            // rating_star($rate); 
                    ...
                    <div class="texthe1">ผลลัพธ์ที่ใกล้เคียง</div>
                            @if(isset($similar)?$similar:'')
                                @foreach($similar as $simiilar) 
                                    <div class="column-mdd-s">
                                        <div class="layoutMDD">
                                            <a href="itemdetaliMDD/{{$simiilar->project_m_id}}">
                                                <div class="textMDD-h" >
                                                    <a href="itemdetaliBD/{{$simiilar->project_m_id}}"><label for="text" class="laout-text" >
                                                        <?php 
